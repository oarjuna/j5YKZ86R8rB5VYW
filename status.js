   ...
   display_status: function(spawn_num,Hive) {
     ...
     var spawn_name = Hive.spawn_names[spawn_num];
      ...
      //  Memory.stats["room." + Game.spawns[spawn_name].room.name + ".controllerProgress"] = Game.spawns[spawn_name].room.controller.progress;
        ...
        if (spawn_name == 'Spawn1') { var url = '<A HREF=https://screeps.com/a/#!/room/shard0/W28S81  style="color:red;">Spawn1</a>'};
        if (spawn_name == 'Spawn2') { var url = '<A HREF=https://screeps.com/a/#!/room/shard0/W27S81  style="color:red;">Spawn2</a>'};
        if (spawn_name == 'Spawn3') { var url = '<A HREF=https://screeps.com/a/#!/room/shard0/W26S81  style="color:blue;">Spawn3</a>'};
