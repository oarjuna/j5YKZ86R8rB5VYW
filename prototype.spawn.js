...
// 1300
  ...
  function(energy_avail, roleName, dest, birthplace,return_id) {
    ...
    // 550 - 799 energy_avail
      ...
      else if (roleName == 'deliverer')   { var body = [ WORk, WORK, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY ]; }                  	// 400
    ...
    // >= 1100 energy_avail
      ...
      if      (roleName == 'harvester') {
          var body = [ WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,  // 1000
