...
// claimer
  ...
  function(energy, roleName, dest, birthplace) {
    ...
    // 550 - 799 energy
      ...
      else if (roleName == "remote_harvester")  { var body = [ WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY ]; }
    ...
    // 800 energy
      ...
      else if (roleName == "remote_harvester")  { var body = [ WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY ]; } // 700 }
      else if (roleName == "claimer")           { var body = [ WORK, WORK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY ]; } //  700 }
      else if (roleName == "claimer_lg")        { var body = [ CLAIM, MOVE, MOVE]; roleName = "claimer";  }// 700 }
