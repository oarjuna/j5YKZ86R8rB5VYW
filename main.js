  ...
  var Hive = {
    ...
    spawn_levels:
                ...
                [// H  D  U  B  E  Rh C  S  R Sm Sr SH
                  [ 2, 3, 4, 1, 0, 1, 0, 0, 0, 0, 0, 0], // Spawn1
                  [ 2, 3, 3, 1, 0, 1, 0, 0, 0, 0, 0, 0], // Spawn2
...
*/
  ...
  for ( let job of Hive.memory.job_queue) {
    console.log("JQ: " + job.spawn_name+ " index " + job.id + " type " + job.type + " " + job.state + " " + job.dest_id + " time_in_q " + ( Game.time - job.tick_issued));
    x++;
  }
  console.log("------ actions ------");
  //console.log("#-------------------------------------------------------#  H, U, R, B, RH, C, De, EM, S");
