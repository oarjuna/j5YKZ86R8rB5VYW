  ...
  var Hive = {
    ...
    spawn_levels:
                ...
                [// H  D  U  B Cr  Rh C  S  R Sm Sr SH
                  ...
                  [ 2, 2, 3, 0, 0, 0, 0, 0, 0, 0, 0, 0], // Spawn2
...
*/
  ...
  if ( job.state == 'assigned' || job.type == '01bb' || job.type == '02ff') {
      Log.info(job.id + " @ " + job.spawn_name + "\tp: " + job.priority + "\tt: " + j_type + "\td: " + dest_type + " (" + job.type + ") " + "\ttq " + ( Game.time - job.tick_issued) + "\tcr: " + name ,'Queue');
    }
  }
  console.log("------ END ------");
